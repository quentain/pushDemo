 ...
 * 
 */
public class ListViewOnNet extends ListView implements OnScrollListener,
		OnClickListener {
	// 拖拉ListView枚举所有状态
	 ...
	 * @param context
	 */
	public ListViewOnNet(Context context) {
		super(context);
	 ...
	 * @param defStyle
	 */
	public ListViewOnNet(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs
	 */
	public ListViewOnNet(Context context, AttributeSet attrs) {
		super(context, attrs);
		initDragListView(context);
	}
	...
	public void initDragListView(Context context) {
		...
		// new Date()为获取当前系统时间
		String time = df.format(new Date());// 更新时间
	...
	public void initHeadView(Context context, String time) {
		...
		// 显示更新事件
		mLastUpdateTextView.setText("近期更新:" + time);
...
//				R.layout.footer_on_net, null);
//
//		mLoadMoreView = mFootView.findViewById(R.id.load_more_on_net);
//
//		mLoadMoreTextView = (TextView) mFootView
//				.findViewById(R.id.load_more_text_view);
//
//		mLoadingView = (LinearLayout) mFootView
//				.findViewById(R.id.loading_more_on_net);
//
